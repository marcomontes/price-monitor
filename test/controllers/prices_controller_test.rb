...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { price: @price.price, price_offer: @price.price_offer, price_offer_2: @price.price_offer_2, product_id: @price.product_id } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { price: @price.price, price_offer: @price.price_offer, price_offer_2: @price.price_offer_2, product_id: @price.product_id } }
